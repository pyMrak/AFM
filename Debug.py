...
Folder='//corp.hidria.com/aet/SI-TO-Izmenjava/Andrej_Mrak/__Nove_Meritve/TC/a-Fiat090517/'
Analysis(TC=True, R=False, mark=False, maxlines=6005, MeasDur=60, graph=1, IG=True,QC='968', folder = Folder)
