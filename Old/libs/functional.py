...
#    else:
    ...
    #print(end) 
    print('Process lasted',end-start, 's')
    return [lastFile]
...
class debug():
    ...
    def __init__(self, TC=False, R=False, mark=False, maxlines=6505, MeasDur=60, graph=1, IG=True,QC='968', folder = 'measurements', QCpath='global'):
        self.podatki = rd.measurment_data()#TC=TC, R=R, mark=mark, maxlines=maxlines, MeasDur=MeasDur, folder=folder, graph=graph, curr=IG )
