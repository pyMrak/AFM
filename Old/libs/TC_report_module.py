...
def write_TC_header(gdat, wb, i):
    wb['Poročilo'].add_image(Image('Graphic\Pic\Hidria_AET.png'), 'B1')
...
def write_TC_diff_graph(wb):
    ...
    wb['Poročilo'].add_image(Image('Graphic\Pic\Xaxis_units.png',size=(70, 20)), 'G40')
    wb['Poročilo'].add_image(Image('Graphic\Pic\yaxis_units.png',size=(20, 90)), 'C31')
...
#write functional graph
    ...
    wb['Poročilo'].add_image(Image('Graphic\Pic\Graph_legend.png',size=(100, 130)), 'L49')
    wb['Poročilo'].add_image(Image('Graphic\Pic\Xxaxis_units.png',size=(50, 13)), 'H71')
    wb['Poročilo'].add_image(Image('Graphic\Pic\Y1axis_units.png',size=(13, 75)), 'C60')
    wb['Poročilo'].add_image(Image('Graphic\Pic\Y2axis_units.png',size=(13, 50)), 'N61')
